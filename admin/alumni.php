					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$alumni = $conn->query("SELECT *, Concat(lastname,', ',firstname,' ',middlename) as name from alumnus_bio where status = 0 order by Concat(lastname,', ',firstname,' ',middlename) asc");
...
<script>
	...
	$('.view_alumni').click(function(){
		uni_modal("User","view_alumni.php?id="+$(this).attr('data-id'),'mid-large')
