...
if (!$con) {
  ...
  $sql ="SELECT graduates.graduates - COUNT(college_year) AS total_untracked, batch_year FROM graduates inner join graduate_survey_form WHERE batch_year = college_year  GROUP BY batch_year";
  $result = mysqli_query($con,$sql);
  $chart_data="";
  while ($row = mysqli_fetch_array($result)) { 
     $batch[]  = $row['batch_year']  ;
     $total[] = $row['total_untracked'];
 }
}
?>
	...
	<div class="col-lg-12">
		<div class="row">
			...
			<div class="col-md-4">
                ...
                <br>
                <br>
                <h2 class="page-header" style="text-align:center;color:white;color:black;">Graphical Reports of Untrack Graduates</h2>
                    <div style="text-align:center;color:white; color:black;">Not Tracked Data</div>
