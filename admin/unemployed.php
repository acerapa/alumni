...
if (!$con) {
  ...
  $sql ="SELECT COUNT(employment_status) AS total_unemployed, batch_year FROM graduates inner join graduate_survey_form WHERE batch_year = college_year and employment_status = 'unemployed' GROUP BY batch_year";
  $result = mysqli_query($con,$sql);
  $chart_data="";
  while ($row = mysqli_fetch_array($result)) { 
     $batch[]  = $row['batch_year']  ;
     $total[] = $row['total_unemployed'];
 }
}
?>
	...
	<div class="col-lg-12">
		<div class="row">
			...
			<div class="col-md-4">
                ...
                <br>
                <br>
                <h2 class="page-header" style="text-align:center;color:white;color:black;">Graphical Reports of Unemployed Graduates</h2>
                    <div style="text-align:center;color:white; color:black;">Unemployed Data</div>
